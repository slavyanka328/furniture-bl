...
namespace Furniture
{
    internal class DateContext
    {
        ...
        public DateContext()
        {
            ...
            nextId = 1;
            Products.Add(new Product(nextId++, 1, "Шкаф", 700));
            Products.Add(new Product(nextId++, 2, "Стол", 300));
            Products.Add(new Product(nextId++, 3, "Стул", 500));
        }
        ...
        public void DisplayMainMenu()
        {
            ...
            while (running)
            {
                ...
                Console.WriteLine("4 - Просмотреть категории");
        ...
        public void DisplayProducts()
        {
            ...
            else
            {
                ...
                {
                    Console.WriteLine($"Порядковый номер: {product.Id} | ID: {product.IdProduct} | Название: {product.Name} | Цена: {product.Price}");
                }
            }
            Console.WriteLine("=====================================");
        ...
        public void AddProduct()
        {
            ...
            Products.Add(new Product(nextId++, nextId-1, name, price)); 
        ...
        public class Product
        {
            ...
            public Product(int id, int idProduct, string name, decimal price)
            {
                Id = id;
                Name = name;
                Price = price;
